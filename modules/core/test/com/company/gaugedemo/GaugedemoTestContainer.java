...
public class GaugedemoTestContainer extends TestContainer {

    public GaugedemoTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/gaugedemo/app.properties",
    ...
    public static class Common extends GaugedemoTestContainer {

        public static final GaugedemoTestContainer.Common INSTANCE = new GaugedemoTestContainer.Common();
